		...
		<div id="waBestSellers.CategoryList" class="iLayer" style="left: 0px; display: block;" title="Categories">
			<div class="iMenu">
                ...
                <% foreach (string category in Model)
                   { %>
					<li><a href="<%Response.Write(HttpUtility.UrlPathEncode(category));%>" rev="async">
                        <img src="../../NytIcon.png" style="max-height: 44px; max-width: 32px">
                        <em><%Response.Write(category);%></em><small class="iFactrSmall" style="color: #666666"></small></a>
                    </li>
                <% } %>
				</ul>
			</div>
