...
{
    public class BookView : MXView<Book>
    {
        public override void Render()
        {
            ...
            image.Attributes.Add("src", string.Format("http://images.amazon.com/images/P/{0}.01.ZTZZZZZZ.jp", Model.ISBN10));
            ...
            MXWebkitContainer.WriteControlToResponse("BookDetail", Model.Title, div);
        }
    }
}