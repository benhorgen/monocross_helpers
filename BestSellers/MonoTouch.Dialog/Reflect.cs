		...
		void Populate (object callbacks, object o, RootElement root)
		{
			...
			foreach (var mi in members){
				...
				if (mType == typeof (string)){
					...
					if (pa != null) {
						UITextAlignment eAlign = UITextAlignment.Right;
						if (align != null)
							eAlign = align.Alignment;
						element = new EntryElement (caption, pa.Placeholder, eAlign, value, true);
					} else if (ea != null) {
						UITextAlignment eAlign = UITextAlignment.Right;
						if (align != null)
							eAlign = align.Alignment;
						element = new EntryElement (caption, ea.Placeholder, eAlign, value) { KeyboardType = ea.KeyboardType };
					} else if (multi) {
